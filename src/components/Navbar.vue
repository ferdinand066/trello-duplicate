    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between h-16">
        <div class="flex">
          ...
          <router-link
            :to="'/'"
            class="flex-shrink-0 flex items-center text-2xl font-semibold italic"
          >
            Trello
          </router-link>
        ...
        <div class="flex items-center">
          ...
          <div v-else class="flex-1 flex flex-row">
            <div class="flex-shrink-0">
              <button
                type="button"
                @click="openNewBoardPopup = !openNewBoardPopup"
                ...
                <div>
                  ...
                  >
                    ...
                    <img
                      ...
                      :src="(authStore?.googleUser as any).picture"
                      alt=""
                    />
                  </MenuButton>
                </div>
          ...
          <div class="ml-3 flex flex-row justify-between flex-1 items-center">
            <div>
              <div class="text-base font-medium text-gray-800">
                {{ (authStore?.googleUser as any).name }}
              </div>
              <div class="text-sm font-medium text-gray-500">
                {{ (authStore?.googleUser as any).email }}
              </div>
            </div>
            <ArrowUturnRightIcon
              class="w-5 h-5"
